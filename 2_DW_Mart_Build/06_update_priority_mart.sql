------- Sixth step: Mart - Update priority roles mart

SELECT 'Updating Roles for Priority Mart' AS update_role;
----------------- Update Data Engineer to Priority 1 -------------------
UPDATE priority_mart.priority_roles
SET priority_lvl = 1
WHERE role_name = 'Data Engineer';

--------------- Add Data Scientist at level 3 ----------------------
...
------------------------- Create TEMP Table -------------------------------------------------
SELECT 'Temporary table creation for priority mart' AS temp_creation;
...
------------------------- MERGE INTO --------------------------------------
SELECT 'Batch Updating priority_jobs_snapshot for Priority Mart' AS batch_update;
